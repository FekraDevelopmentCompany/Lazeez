...
namespace Lazeez.Helper
{
    public static class Upload
    {
        ...
        public static string GetStaticPath(int sourceId, Enums.SourceType sourceType)
        {
           return Path.Combine(System.Configuration.ConfigurationManager.AppSettings["UploadPath"], sourceType.ToString(), sourceId.ToString());
        }
    }
}