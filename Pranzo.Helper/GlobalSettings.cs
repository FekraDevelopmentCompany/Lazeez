...
namespace Lazeez.Helper
{
    ...
    {
        public const string AppPrefix = "Lazeez.";
        ...
        public static int? RestaurantBranchID
        {
            get
            {
                var httpCookie = HttpContext.Current.Request.Cookies[AppPrefix + "RestaurantBranchID"];
                return httpCookie != null ? int.Parse(httpCookie.Value) : 0;
            }
            set
            {
                ...
                {
                    httpCookie = new HttpCookie(AppPrefix + "RestaurantBranchID")
                    {
                        Value = value.ToString(),
                        Expires = DateTime.Now.AddDays(1)
                    };
